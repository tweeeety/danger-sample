...
var Executor = (function () {
    function Executor(ciSource, platform, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, DangerfileRunner_1.runDangerfileEnvironment(file, runtime)];
                    case 2:
                        results = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    Executor.prototype.handleResultsPostingToSTDOUT = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            var fails, warnings, messages, markdowns, table, s, are, message, message;
            return __generator(this, function (_a) {
                ...
                if (fails.length > 0) {
                    ...
                    message = chalk.underline("Failing the build");
                    console.log(message + ", there " + are + " " + fails.length + " fail" + s + ".");
                    process.exitCode = 1;
                }
                else if (warnings.length > 0) {
                    message = chalk.underline("not failing the build");
    ...
    Executor.prototype.handleResultsPostingToPlatform = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            var fails, warnings, messages, markdowns, failureCount, messageCount, s, are, comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fails = results.fails, warnings = results.warnings, messages = results.messages, markdowns = results.markdowns;
                        ...
                        this.d(results);
                        if (!(failureCount + messageCount === 0)) return [3 /*break*/, 2];
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        if (!this.options.verbose) return [3 /*break*/, 6];
