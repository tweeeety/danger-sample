...
var GitHub = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        labels = issue.labels.map(function (label) { return ({
                            id: label.id,
                            url: label.url,
                            name: label.name,
                            color: label.color,
                        }); });
                        return [2 /*return*/, { labels: labels }];
                }
            });
        });
    };
    ...
    GitHub.prototype.getPlatformDSLRepresentation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pr, issue, commits, reviews, requested_reviewers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                utils: GitHubUtils_1.default(pr)
                            }];
                }
            });
        });
