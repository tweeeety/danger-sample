...
var FakeCI = (function () {
    ...
    Object.defineProperty(FakeCI.prototype, "name", {
        get: function () { return "Fake Testing CI"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FakeCI.prototype, "isCI", {
        get: function () { return ci_source_helpers_1.ensureEnvKeysExist(this.env, ["DANGER_FAKE_CI"]); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(FakeCI.prototype, "pullRequestID", {
        get: function () { return this.env.pr; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FakeCI.prototype, "repoSlug", {
        get: function () { return this.env.repo; },
        enumerable: true,
        configurable: true
    });
